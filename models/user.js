...
// Using the bcryptjs version as the regular bcrypt
// module sometimes causes errors on Windows machines
...
module.exports = function(sequelize, DataTypes) {
  ...
  to the hashed password stored in our database */
  User.prototype.validPassword = function(password) {
    return bcrypt.compareSync(password, this.password);
  };
  // Hooks are automatic methods
  // that run during various phases of the User Model lifecycle
